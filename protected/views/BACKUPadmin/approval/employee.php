...
$this->widget('booster.widgets.TbGridView',array(
        'id'=>'supprier-grid',
        'dataProvider'=>$model->searchdepartments(Yii::app()->user->getdepartments()),
        'filter'=>$model,
	'columns'=>array(
            array(
            'name' => 'id',
            ...
            'buttons' => array(
                'insert' => array(
                    ...
                    'options' => array(
                        ...
                        'onclick' => 'selectDataemployee($(this).parent().parent().children(":nth-child(2)").text(),$(this).parent().parent().children(":nth-child(3)").text(),$(this).parent().parent().children(":nth-child(4)").text());',
                    ),
                ),
                'info' => array
                    (
