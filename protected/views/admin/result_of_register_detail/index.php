<div class="row">
    <div class="col-xs-12">
        ...
        <div id='mainbox_profile'>
            ...
            <div id='profile'>
                <div class="h_profiles"><h3>Result of Register Course</h3><br>ประกาศผลผู้มีสิทธิในการเข้าอบรม</br></div>
                        ...
                        <div class="col-xs-12 column">
                            <table class="table table-striped">
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            จำนวนผู้ผู้มีสิทธิในการเข้าอบรม :&nbsp:<?=CourseRegister::checkmaxapprovel($datacourse->cu_id)?> &nbsp;คน
                                        </td>
                                        <td>
                                            จำนวนผู้ไม่ผู้มีสิทธิในการเข้าอบรม :&nbsp;<?=CourseRegister::checkmaxcalcel($datacourse->cu_id);?> &nbsp;คน
                                        </td>
                                        <td></td>
