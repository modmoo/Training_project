...
echo '<input  type="text" placeholder="ระบุปีที่ต้องการค้นหา" style="width:250px;height: 34px;border: 1px solid #ccc;" name="year">&nbsp;';
echo CHtml::submitButton('ค้นหา', ['class' => 'btn btn-primary']);
$this->endWidget();
            ?>
            <?php
            $oldyear="";$i=0;
