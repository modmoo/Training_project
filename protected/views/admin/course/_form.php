      ...
      $("#boxisupprier").slideDown("slow",function(){ 
        ...
        $("#addButton_training").click(function() {
            ...
            newTextBoxDiv.after().html('<table cellpadding="0" cellspacing="0" style="margin: 0 auto 0 10%;" border="0">' +
                    ...
                    '<input style="width:100px;" id="mydaymore" class="form-control ct-form-control" type="text"' +
                    ...
                    '<input style="width:100px;" id="mydayfirsttime" class="form-control" type="text" placeholder="12:00" name="timeend[]" value="">' +
                    '<span class="input-group-addon"><span class="glyphicon glyphicon-time"></span></span>' +
                    '</div> </div></td></tr><tr>' +
                    '<td colspan="6">' +
...
$('#datetimepicker_start,#datetimepicker_end,#mydaytwottime').datetimepicker({
  pickDate: false
});
$('#mydayfirst').datepicker();
...
<script type="text/javascript">
    $(document).ready(function() {
     ...
     //$(':input[type="text"][id="mydayfirsttime"]').datetimepicker({pickDate: false}); 
       $('body').on('focus',':input[type="text"][id="mydayfirsttime"]', function(){
        $(this).datetimepicker({pickDate: false});
    });
     $('body').on('focus',':input[type="text"][id="mydaymore"]', function(){
  ...
  <?php if (Yii::app()->user->hasFlash('error')):  ?>
          ...
          <?php 
            Yii::app()->clientScript->registerScript(
                   'myalertEffect',
                   "swal('Error...!', 'ไม่สามารถบันทึกข้อมูลได้ค่ะ!', 'error');",
                   CClientScript::POS_READY
                );
         ?>
     <?php endif; ?> 
...
<fieldset class="myfieldset">
    ...
    <div class="well">
        ...
        <?php echo $form->textFieldGroup($model, 'price', array('widgetOptions' => array('htmlOptions' => array('style' => 'width:120px;')))); ?>
